    ...
    <div>
      <FormControl>
        ...
        <Box>
          ...
          <Input value={event.location} type="text" name="location" onChange={handleChange} />
        </Box>
        <Box>
          <FormLabel>Descrition</FormLabel>{" "}
          <Input value={event.description} type="text" name="description" onChange={handleChange} />
        </Box>
